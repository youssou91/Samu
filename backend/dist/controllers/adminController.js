"use strict";const Utilisateur = require('../models/Utilisateur');
...
exports.exporterRendezVous = asyncHandler(async (req, res) => {
  ...
  // Formater les données pour l'export
  const donnees = rendezVous.map((rdv) => {var _rdv$patient, _rdv$patient2, _rdv$patient3, _rdv$medecin, _rdv$medecin2;return {
      'ID': rdv._id,
      ...
      'Statut': rdv.statut,
      'Notes': rdv.notes || '',
      'Patient ID': ((_rdv$patient = rdv.patient) === null || _rdv$patient === void 0 ? void 0 : _rdv$patient._id) || '',
      'Patient': rdv.patient ? `${rdv.patient.prenom} ${rdv.patient.nom}` : 'Inconnu',
      'Email patient': ((_rdv$patient2 = rdv.patient) === null || _rdv$patient2 === void 0 ? void 0 : _rdv$patient2.email) || '',
      'Téléphone patient': ((_rdv$patient3 = rdv.patient) === null || _rdv$patient3 === void 0 ? void 0 : _rdv$patient3.telephone) || '',
      'Médecin ID': ((_rdv$medecin = rdv.medecin) === null || _rdv$medecin === void 0 ? void 0 : _rdv$medecin._id) || '',
      'Médecin': rdv.medecin ? `Dr. ${rdv.medecin.prenom} ${rdv.medecin.nom}` : 'Non attribué',
      'Spécialité': ((_rdv$medecin2 = rdv.medecin) === null || _rdv$medecin2 === void 0 ? void 0 : _rdv$medecin2.specialite) || '',
